      ...
      <main className="cv-content">
        <section className="personal-info-section">
          ...
          <div className="info-grid">
            ...
            <div className="info-item">
              ...
              <span className="info-value">
                {cvData2.data[0].phone_numbers?.join(", ") || "N/A"}
              </span>
            </div>
            <div className="info-item">
              <span className="info-label">
              ...
              <span className="info-value">
                {cvData2.data[0].emails?.join(", ") || "N/A"}
              </span>
            </div>
            <div className="info-item">
              <span className="info-label">
            ...
            <div className="info-item">
              ...
              <span className="info-value">
                {cvData2.data[0].country_name || "N/A"}
              </span>
            </div>
            <div className="info-item">
              <span className="info-label">
              ...
              <span className="info-value">
                {cvData2.data[0].date_of_birth || "N/A"}
              </span>
            </div>
          </div>
        </section>
        ...
        <section className="skills-section">
          ...
          <div className="skills-container">
            {cvData2.data[0].skills ? (
              typeof cvData2.data[0].skills === "string" ? (
                <p>{cvData2.data[0].skills}</p>
              ) : (
                <ul className="skills-list">
                  {cvData2.data[0].skills.map((skill, index) => (
        ...
        {cvData2.data[0].education?.length > 0 && (
          <section className="education-section">
            <h2 className="section-title">
              <i className="fas fa-graduation-cap"></i> Education
            </h2>
            <div className="timeline">
              {cvData2.data[0].education.map((edu, index) => (
        ...
        <section className="experience-section">
          ...
          {cvData2.data[0].experience && (
            <div className="experience-details">
              {typeof cvData2.data[0].experience === "string" ? (
                <p>{cvData2.data[0].experience}</p>
              ) : (
                <ul className="experience-list">
                  {Array.isArray(cvData2.data[0].experience) &&
                    cvData2.data[0].experience.map((exp, index) => (
        ...
        <div className="experience-summary">
          <p>
            ...
            {cvData2.data[0].total_work_experience || "N/A"}
          </p>
        </div>

        {cvData2.data[0].certifications && (
          <section className="certifications-section">
            <h2 className="section-title">
              <i className="fas fa-certificate"></i> Certifications
            </h2>
            <div className="certifications-container">
              {typeof cvData2.data[0].certifications === "string" ? (
                <p>{cvData2.data[0].certifications}</p>
              ) : (
                <ul className="certifications-list">
                  {cvData2.data[0].certifications.map((cert, index) => (
        ...
        {cvData2.data[0].referre_details &&
          Array.isArray(cvData2.data[0].referre_details) && (
            <section className="summary-section">
              ...
              <div className="summary-content">
                <ul className="referee-list">
                  {cvData2.data[0].referre_details.map((ref, index) => (
