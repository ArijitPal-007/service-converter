...
function Analyser() {
  const url = "https://aiml-document-analyser.reca.ai/document/document-classification-extraction";
          ...
          {document ? (
            <div className="cv-details">
              <div className="cv-details-content">
                ...
                <ul>
                <h3><strong>Document Type:</strong> {document.docType}</h3>

  {Object.entries(document.extracted_data[0] || {}).map(([key, value], idx) => (
    <li key={idx}>
